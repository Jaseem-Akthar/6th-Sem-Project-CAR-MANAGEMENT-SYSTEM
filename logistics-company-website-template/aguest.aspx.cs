...
public partial class logistics_company_website_template_aguest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ctr > 0)
            {
                ...
                //string ss = "select * from payment2 where emailid=" + "'" + em + "'";
                //// Response.Write(ss);

                //con.Open();

                //SqlCommand cmd11 = new SqlCommand(ss, con);
