<%@ Page Language="C#" AutoEventWireup="true" CodeFile="astaff.aspx.cs" Inherits="logistics_company_website_template_astaff" %>
    ...
    <!-- Topbar End -->
     ...
     <div class="container-fluid p-0">
       ...
       <br />    <br />    <br />    <br />    <br />
        ...
        <table class="w-100">
            <tr>
                <td colspan="2" style="text-align: center">STAFF DETAILS</td>
                <td>&nbsp;</td>
            </tr>
            
            <tr>
                <td class="text-center" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="717px">
