<%@ Page Language="C#" AutoEventWireup="true" CodeFile="guestreg.aspx.cs" Inherits="logistics_company_website_template_guestreg" %>
...
&nbsp;&nbsp;
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox4" ErrorMessage="INVALID MOBILE NO" ValidationExpression="\d{10}"></asp:RegularExpressionValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text-center">AADHAR CARD NO </td>
                <td>
                    <asp:TextBox ID="TextBox6" runat="server" MaxLength="12" TextMode="Number"></asp:TextBox>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox6" ErrorMessage="INVALID AADHAR NO" ValidationExpression="\d{12}"></asp:RegularExpressionValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="text-center">DL NO</td>
                <td>
                    <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox7" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="TextBox9" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/logistics-company-website-template/guestlogin.aspx">Has An Account ?</asp:HyperLink>
&nbsp;&nbsp;
