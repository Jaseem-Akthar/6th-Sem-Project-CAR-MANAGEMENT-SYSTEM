<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editproducts1.aspx.cs" Inherits="logistics_company_website_template_editproducts1" %>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            <a href="index.html" class="navbar-brand ml-lg-3">
                <h1 class="m-0 display-5 text-uppercase text-primary"><i class="fa fa-map-marker-alt mr-2"></i>Wheel's Bro</h1>
            </a>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem>SUPER-BIKES</asp:ListItem>
                    </asp:DropDownList>
                </td>
